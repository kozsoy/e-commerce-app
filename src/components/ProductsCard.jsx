...
const ProductsCard = ({prod }) => {
  return (
    <div className='w-1/5 h-[350px] border-solid border-2 border-sky-500  rounded-lg m-2 flex flex-col items-center p-1 cursor-pointer space-y-2'  >
        ...
        <button className='font-bold border rounded-md bg-green-700 text-white p-1'>SEPETE EKLE</button>
